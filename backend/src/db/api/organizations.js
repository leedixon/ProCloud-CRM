...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.donations_organization =
      await organizations.getDonations_organization({
        transaction,
      });

    output.donors_organization = await organizations.getDonors_organization({
      transaction,
    });
    ...
    output.volunteers_organization =
      await organizations.getVolunteers_organization({
        transaction,
      });
