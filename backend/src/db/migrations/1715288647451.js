module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('volunteers', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('donors', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('donations', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('volunteers', 'email', { transaction });

      await queryInterface.removeColumn('volunteers', 'name', { transaction });
      ...
      await queryInterface.removeColumn('donors', 'birthday', { transaction });

      await queryInterface.removeColumn('donors', 'email', { transaction });

      await queryInterface.removeColumn('donors', 'name', { transaction });

      await queryInterface.removeColumn('donations', 'donorId', {
        transaction,
      });

      await queryInterface.removeColumn('donations', 'method', { transaction });
      ...
      await queryInterface.removeColumn('campaigns', 'target_amount', {
        transaction,
      });
      ...
      await queryInterface.dropTable('donors', { transaction });
