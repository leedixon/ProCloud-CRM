...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/donors/donorsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureDonorsCols';
...
const TableSampleDonors = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (donorsNotify.showNotification) {
      notify(donorsNotify.typeNotification, donorsNotify.textNotification);
    }
  }, [donorsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/donors/donors-view/?id=${id}`);
  };
...
export default TableSampleDonors;
