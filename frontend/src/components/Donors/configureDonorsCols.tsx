...
export const loadColumns = async (
  ...
  const hasUpdatePermission = hasPermission(user, 'UPDATE_DONORS');
  ...
  return [
...

    {
      ...
      valueFormatter: ({ value }) =>
        dataFormatter.donationsManyListFormatter(value).join(', '),
      renderEditCell: (params) => (
        <DataGridMultiSelect {...params} entityName={'donations'} />
      ),
    },
