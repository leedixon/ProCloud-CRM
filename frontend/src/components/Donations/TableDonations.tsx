...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/donations/donationsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureDonationsCols';
...
const TableSampleDonations = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (donationsNotify.showNotification) {
      notify(
        donationsNotify.typeNotification,
        donationsNotify.textNotification,
      );
    }
  }, [donationsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/donations/donations-view/?id=${id}`);
  };
...
export default TableSampleDonations;
